...
A C compiler and `make`. On a Mac: `xcode-select --install`. On Debian or Ubuntu: `sudo apt install build-essential`. Nothing else — no libraries, no package manager, no IDE.
